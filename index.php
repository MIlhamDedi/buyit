...
<html lang="en">
  ...
  <body style="background-color: #00ce8f; font-family: 'Crete Round', serif;">
    ...
    try {
        ...
        $order = "Total number of apples: " . ($appleQty+$_POST['apple-qty']) . "\r\nTotal number of oranges: " . ($orangeQty+$_POST['orange-qty']) . "\r\nTotal number of bananas: " . ($bananaQty+$_POST['banana-qty']) . "\r\n";
        fwrite($orderFile, $order);
        fclose($orderFile);
    } catch (Exception $e) {
        $orderFile = fopen("order.txt", "c+") or die("Unable to open file for write!");
    ...
    <div >
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <h5 style="text-align: center;" class="modal-title" id="exampleModalLabel">Thank You For The Purchase, <b><?php echo !isset($_POST['name']) || empty($_POST['name']) || is_null($_POST['name']) ? "<em>Anonymous</em>" : $_POST['name']; ?></b>!</h5>
          </div>
